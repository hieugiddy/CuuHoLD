...
(function($) {
    ...
    function _createTimepicker($input) {
        ...
        if (settings.use12HourClock) {
            ...
            hour_header.className = "text-center col-sm-5";
            min_header.className = "text-center col-sm-5";
            hour_select.className = "col-5 hour-select";
            min_select.className = "col-5 min-select";

            var ampm_button = document.createElement("span");
            ...
            ampm_button.className = "btn btn-outline-primary ampm-button";
            ampm_button_wrapper.className = "col-2 mx-auto";
        } else {
            // default width of the picker is 12rem
            $(picker).css("width", "16rem");
            hour_select.className = "col-sm-6 hour-select";
            min_select.className = "col-sm-6 min-select";
        }
